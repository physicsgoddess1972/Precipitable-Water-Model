	...
	<main class="mdl-layout__content">
		...
		<div class='content'>
			...
			<div class="collapsible" id="posters">
				...
				{% for posters in site.data.research.posters %}
					<div class="panel">
						<div class="collapsible_1">
							<div class="panel">
								<img src="https://github.com/physicsgoddess1972/Precipitable-Water-Model/blob/docs/docs/assets/img/poster/{{posters.image}}?raw=true" width="100%">
								<h2 style="text-align: center; font-size: 15px">{{posters.title}}</h2>
								<b>{{posters.author}}</b>
								<br>
								<i>{{posters.conference}}</i>
								<hr>
								<p>{{posters.abstract}}</p>
							</div>
						</div>
					</div>
				{% endfor %}
