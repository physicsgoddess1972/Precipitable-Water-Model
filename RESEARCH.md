...
<div class="panel">
    <div class="collapsible_1">
        ...
        <br>
        <i style="float right">Atmospheric Measurement Techniques</i><p style="font-weight: bold; float: right">Under Review</p>
        <br>
        <br>
        <a class="button" target="_blank" style="width: 49%; text-align: center" href="https://doi.org/10.5194/amt-2021-130">Web View</a>
        <a class="button" target="_blank" style="width: 49%; text-align: center" href="https://amt.copernicus.org/preprints/amt-2021-130/amt-2021-130.pdf">PDF View</a>
        </div>
    </div>
</div>
</div>
...
<div class="panel">
    <div class="collapsible_1">
        <div class="panel">
            ...
            <h3 style="float: left; width: 50%">V. Kelsey, S. Riley</h3><h3 style="float: right; width: 50%; text-align: right">American Meteorlogical Society 100</h3>
            <br>
            <p>
    ...
    <div class="collapsible_1">
        <div class="panel">
            ...
            <h3 style="float: left; width: 50%">V. Kelsey, S. Riley</h3><h3 style="float: right; width: 50%; text-align: right">Physics Congress 2019</h3>
            <br>
            <p>
    ...
    <div class="collapsible_1">
        <div class="panel">
            ...
            <h3 style="float: left; width: 50%">S. Riley, V. Kelsey</h3><h3 style="float: right; width: 50%; text-align: right">Physics Congress 2019</h3>
            <br>
            <p>
