...
# plt.plot(t1,exp(yy_log1), color="limegreen", label='%2.3f$e^{%2.3f x}$\t|\tln(x + 1)' % tuple(popt_log1))
# plt.plot(t1,exp(yy_log2), color="mediumblue", label='%2.3f$e^{%2.3f x}$\t|\tln(x)' % tuple(popt_log2))
